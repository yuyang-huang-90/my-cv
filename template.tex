...
Japan}{Recommendation backend team}{
  \begin{itemize}
    \item Designed and implemented the candidate recommendation system for
      specific job, supporting 8 different countries.
    \item Led a sub-team to improve multiple backend service scalability and stability.
  \end{itemize}
}

\cventry{August 2020--November 2021}{Software Engineer}{Google}{Munich Germany}{Android auto team}{
  \begin{itemize}
    \item Designed and implemented the next generation vehicle-to-phone connectivity library.
    \item Designed and implemented next generation projecting library for Android phones.
...
Japan}{Base system research and development team}{
  \begin{itemize}
    \item Designed and implemented a secure application framework for embedding Linux in next-generation robots.
    \item Linux kernel/driver development and performance turning for next-generation embedded system platform.
  \end{itemize}
}
...
\cventry{November 2021--Present}{Recommends best matched candidates for specific open job positions.}{Candidate recommendation system backend development, @Indeed}{Java, Kotlin}{}{
  \begin{itemize}
    \item Integrated the inference server with Amazon DynamoDB as permanent backend storage which increased the supported candidate count by 3x from the storage perspective.
...
\cventry{August 2020--November 2021}{Next-generation phone to vehicle connectivity and projection library.}{Android Auto and AAOS software development, @Google}{C/C++, Android Java}{}{
  \begin{itemize}
    \item Designed and implemented next generation phone to car connectivity library which provided a unified phone to vehicle communication layer. This library manages USB, Wi-Fi and Bluetooth (RFComm, BLE) as underline transports and makes low level connection details agnostic to the application used.
    \item Improved the connectivity library stability and extensibility by redesigned the threading model. 
    \item Designed and implemented an application-level projecting library which support phone to vehicle projection for android phones.
  \end{itemize}
}
...
platform development, @Goldman Sachs}{Java,C/C++,Python}{}{
  \begin{itemize}
    \item Designed and implemented a next generation sequencer based ultra-low latency electrical trading platform, which provided less than 150 microsecond ends to end latency for synthetic market access.
...
software development, @Sony}{C/C++,Python,Go}{}{
  \begin{itemize}
    \item Customized the Linux kernel and driver for Sony robot dog.
    \item Reduced the kernel crash rate by around 30\% and reduced the kernel boot time by around 40\%.
    \item Designed and implemented runC based containerization software for embedded Linux platform with limited resources.
  \end{itemize}
}
...
\cvlistitem{\textbf{Other technologies:} GRPC, GraphQL, Rate limiter.}
