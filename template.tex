...
\cventry{November 2021--Present}{Software Engineer}{Indeed}{Tokyo Japan}{}{
  \begin{itemize}
    \item Worked in the candidate matching system backend team (team of approx. 12).
    \item Designed and developed the candidate recommendation system for employer
      which support 8 different countries.
      \begin{itemize}
        ...
        \item Worked on the job feature service to improve the stability of the
          service and make it scale to support 14x more traffic volume.
      \end{itemize}
  \end{itemize}
}
...
\begin{itemize}
  ...
  \item[--]{Did performance analysis on the job feature service. Applied rate
    limiter and multi-layer caching which resolve the performance bottleneck and support 14x more traffic volume.}
\end{itemize}
