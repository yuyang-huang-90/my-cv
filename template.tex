...
\cventry{August 2020 -- Present}{Software Engineer}{Google}{Munich German}{}{
  \begin{itemize}
    \item Work in Android Auto team.
    \item Main focus on vehicle to phone connectivity.
      \begin{itemize}
        \item Build next generation phone to vehicle connectivity system
          software.
        \item Build next generation projecting solution for android phone.
      \end{itemize}
  \end{itemize}
}
...
\begin{itemize}
  \item[--]{Design and implement the next generation connectivity system
    software which can provide a unified phone to vehicle communication layer.
    It manages the USB, Wi-Fi, Bluetooth(RFComm, BLE) as underline transports
    and makes low level connection detail s agnostic to the application.}
...
\cvlistitem{Programming language: C/C++, Java, Python, Assembly, Golang, Ruby/Rails.}
