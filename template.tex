...
\cventry{November 2021--Present}{Software Engineer}{Indeed}{Tokyo Japan}{}{
  \begin{itemize}
    \item Worked in the backend team for the candidate matching system (team of approx. 12).
...
\cventry{August 2020--November 2021}{Software Engineer}{Google}{Munich Germany}{}{
  \begin{itemize}
    ...
    \item Built the next generation vehicle-to-phone connectivity system
      software.
    \item Built next generation projecting solution for Android phones.
    \item Led a sub-team to redesign the threading model of phone to
      car communication library.
  \end{itemize}
}
...
Japan}{}{
  \begin{itemize}
    ...
    \item Linux kernel/driver development for both current and next-generation embedded system platform.
  \end{itemize}
}
...
\begin{itemize}
  ...
  \item[--]{Applied rate limiter and multi-layer caching which resolved the performance bottleneck
...
\begin{itemize}
  ...
  \item[--]{Designed and implemented an application level projecting solution for phone to vehicle projection.}
\end{itemize}
...
\cvlistitem{Android system and application development.}
